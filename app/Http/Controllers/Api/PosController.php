...
class PosController extends Controller
{
   ...
   public function OrderDone(Request $request){
    ...
    $this->orderDetailsInsert($order_id);
    $this->deletePOs();
    DB::commit();
    }
    catch (\Exception $e) {
   ...
   public function orderDetailsInsert($order_id){
    ...
    $this->productStockUpdate($content->pro_id,$content->pro_quantity);
    }
    return true;
   }

   public function productStockUpdate($product_id,$product_quantity){
     DB::table('products')
            ->where('id',$product_id)
            ->update(['product_quantity' => DB::raw('product_quantity -' .$product_quantity)]);
         return true;
   }
