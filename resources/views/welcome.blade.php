    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="index.html">
          ...
          <router-link to="/home"> <span>Dashboard</span></a></router-link>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="index.html">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <router-link to="/pos"> <span>Pos</span></a></router-link>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseEmployee" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <router-link to="/employee" class="collapse-item">Employee List</router-link>
          </div>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div id="collapseSupplier" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <router-link to="/supplier" class="collapse-item">Supplier List</router-link>
          </div>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div id="collapseCategory" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <router-link to="/category" class="collapse-item">Category List</router-link>
          </div>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div id="collapseProduct" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <router-link to="/product" class="collapse-item">Product List</router-link>
...
<li class="nav-item">
   ...
   <router-link class="collapse-item" to="/salary">All Salary</router-link>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        <!-- TopBar -->
        <nav v-show="$route.path==='/' || $route.path==='/register' || $route.path==='/forget'? false: true " class="navbar navbar-expand navbar-light bg-navbar topbar mb-4 static-top" id="topbar" style="display:none">
